...
function start(done) {
    ...
    walker = walk.walk("test/sampleImages", options);
...
describe('For Canon images', function () {
    it('should find InternalSerialNumber (used to incorrectly be InternalSerialInfo)', function (done) {
        exiftoolJS.getExifFromLocalFileUsingNodeFs(fs, 'test/sampleImages/Canon/CanonEOS1000D.jpg',
                function (err, exif) {
    ...
    it('should zero-pad SerialNumber', function (done) {
        exiftoolJS.getExifFromLocalFileUsingNodeFs(fs, 'test/sampleImages/Canon/CanonDigitalRebelXT.jpg',
                function (err, exif) {
    ...
    it('should not trim last character from InternalSerialNumber', function (done) {
        exiftoolJS.getExifFromLocalFileUsingNodeFs(fs, 'test/sampleImages/Canon/CanonEOS_REBEL_T1i.jpg',
                function (err, exif) {
...
describe('dfries bugs', function () {
    it('should decode mores ascii', function (done) {
        exiftoolJS.getExifFromLocalFileUsingNodeFs(fs, 'test/sampleImages/Daisy/DaisyMultimedia.jpg',
                function (err, exif) {
    ...
    it('shouldnt drop last char', function (done) {
        exiftoolJS.getExifFromLocalFileUsingNodeFs(fs, 'test/sampleImages/DXG/DXG_DZ358.jpg',
                function (err, exif) {
...
describe('For _Other images', function () {
    it('if SerialNumber not parsed, omit from response (although in this case, we should really be getting a SN)', function (done) {
        var fdVakantie,
            bufferVakantie,
            readSize = 100000;
        fdVakantie = fs.openSync('test/sampleImages/_Other/vakantie anna frankrijk 094.JPG', 'r');
    ...
    it('Parse imageuniqueid even if its alread a string and not array of ints', function (done) {
        var fdIMG2705,
            bufferIMG2705,
            readSize = 100000;
        fdIMG2705 = fs.openSync('test/sampleImages/_Other/IMG_2705.JPG', 'r');
